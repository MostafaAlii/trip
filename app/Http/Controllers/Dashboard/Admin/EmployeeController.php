...
use App\Services\Dashboard\{Admins\EmployeeService,General\GeneralService};
use App\DataTables\Dashboard\Admin\EmployeeDataTable;
use App\Http\Requests\Dashboard\Admin\EmployeeRequestValidation;
class EmployeeController extends Controller
{
    ...
    public function index() {
        ...
        return $this->dataTable->render('dashboard.admin.employees.index',  compact('data'));
    }

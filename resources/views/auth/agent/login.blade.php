@extends('layouts.common.auth.login_master')
@section('css')
@endsection
@section('title')
تسجيل الدخول | لوحة التحكم | الوكلاء
@endsection
        ...
        <div class="row justify-content-center no-gutters vertical-align">
            <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                ...
                <div class="login-fancy">
                    <h2 class="mb-20 text-white text-md-center">مرحبا</h2>
            ...
            <!-- Start Col-lg-4 -->
            <div class="bg-white col-lg-4 col-md-6">
                <!-- Start Login Fancy -->
                <div class="clearfix pb-40 login-fancy">
                    <h3 class="mb-30">تسجيل الدخول الوكلاء</h3>
                    @include('layouts.common.partials.messages')
                    <!-- Start Form -->
                    <form method="POST" action="{{ route('agent.login') }}" autocomplete="off">
                        @csrf
                        <!-- Start Email -->

            ...
            <div class="row justify-content-center no-gutters vertical-align">
                <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                    ...
                    <div class="login-fancy">
                        ...
                        <p class="mb-20 text-white text-md-center font-weight-bold pt-50" style="font-size-adjust: inherit;font-size: 36px;">
                            Call-Center
                            <br>
                ...
                <div class="col-lg-4 col-md-6 bg-white">
                    ...
                    <div class="login-fancy pb-40 clearfix">
                        ...
                        <!-- Start Form -->
                        <form method="POST" action="{{ route('callCenter.login') }}" autocomplete="off">
                            @csrf
                            <!-- Start Email -->

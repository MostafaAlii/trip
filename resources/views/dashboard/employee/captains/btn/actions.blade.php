...
@include('dashboard.company.captains.btn.modals.edit')
@include('dashboard.company.captains.btn.modals.updatePassword')
@include('dashboard.company.captains.btn.modals.destroy')
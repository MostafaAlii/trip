                ...
                <form action="{{route('discounts.store')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="code" id="code" value="">
                                @error('code')
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="datetime-local" name="start_data" class="form-control">
                            @error('start_data')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-6">
                            ...
                            <input type="datetime-local" name="end_data" class="form-control">
                            @error('end_data')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="p-1 form-group">
                                ...
                                <input type="number" class="form-control" required name="use_coupon" id="use_coupon" value="">
                                @error('use_coupon')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-4">
                            <div class="p-1 form-group">
                                ...
                                <input type="number" class="form-control" required name="value" id="value" value="">
                                @error('value')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>

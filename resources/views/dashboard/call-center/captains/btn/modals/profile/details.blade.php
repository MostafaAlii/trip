<div class="modal fade" id="addProfileDetail{{ $data['captain']?->id }}" tabindex="-1" role="dialog" aria-labelledby="carRejectModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ ucfirst(str_replace('_', ' ', $data['captain']?->name)) }} Prfile Details</h5>

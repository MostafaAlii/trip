<div class="mb-1 btn-group">
    ...
    <div class="dropdown-menu">
        <button type="button" class="modal-effect btn btn-sm btn-primary dropdown-item"
            style="text-align: center !important" data-toggle="modal" data-target="#edit{{$bonus->id}}"
        ...
        <button type="button" class="modal-effect btn btn-sm btn-primary dropdown-item" style="text-align: center !important"
            data-toggle="modal" data-target="#updateStatus{{$bonus->id}}" data-effect="effect-scale">
        ...
        <button type="button" class="modal-effect btn btn-sm btn-danger dropdown-item"
            style="text-align: center !important" data-toggle="modal" data-target="#delete{{$bonus->id}}"
            data-effect="effect-scale">
...
@include('dashboard.admin.captains.bouns.btn.modals.edit')
@include('dashboard.admin.captains.bouns.btn.modals.updateStatus')
@include('dashboard.admin.captains.bouns.btn.modals.destroy')
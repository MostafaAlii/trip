    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="float-left pt-0 pr-0 breadcrumb float-sm-right ">
                ...
                <li class="breadcrumb-item"><a href="{{route('orderDay.index')}}" class="default-color">Orders Day</a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-5 mb-30" style="font-weight: bold;">
                                                ...
                                                <p class="mb-0">Car Type: {{ucfirst($order?->car_type?->name)}}</p>
                                                <p class="mb-0">Hour From: {{ucfirst($order?->hours_from)}}</p>
                                                <p class="mb-0">Hour: {{ucfirst($order?->hour?->number_hours . ' Hour Price : ( ' . $order?->hour?->offer_price . ' )' )}}</p>

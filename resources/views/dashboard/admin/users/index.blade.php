    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal">Push Notification All  {{$title}}</button>
                <br><br>
                <!--begin::Table-->
                {!! $dataTable->table([
            ...
            @include('dashboard.admin.users.btn.modals.create')
            @include('dashboard.admin.users.notification')
        </div>
    </div>
</div>
<!-- row closed -->

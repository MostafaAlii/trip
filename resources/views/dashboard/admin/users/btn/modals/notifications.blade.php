<!-- Modal -->
<div class="modal fade" id="Notification{{$admin->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('users.sendNotification')}}" method="post">
                    ...
                    <input type="hidden" name="fcm_token_user" value="{{$admin->fcm_token}}">

<div class="modal fade" id="updateStatus{{ $callCenter->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('callCenters.update-status', $callCenter->id)}}" method="POST">
                    @csrf
                    <!-- Start Status Status -->
